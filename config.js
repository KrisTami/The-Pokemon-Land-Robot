...
exports.rooms = ['lobby'], ['staff'], ['public'];
...
exports.initCmds = ['|/avatar 80']; // Other commands (avatar, blockchallenges, etc)
...
exports.initBattleMsg = ['Have fun and safe at PK Land!', 'Cowabunga!'];

exports.winmsg = ['You may try again soon, man!'];

exports.losemsg = ['You did it! Good job!'];

exports.battleMessages = {
	/* Examples of battle messages:
	'crit': {
		'self': ['Critical chance, dude!', 'What a bird!'],
		'foe': ['Got it, dude! *snickers*', 'Hit the weakspot!']
	},
	'miss': {
		'self': ['What happened to your eyes, #poke?']
	}
	*/
};
